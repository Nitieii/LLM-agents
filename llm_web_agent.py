...
search_web = TavilySearchResults(max_results=10, api_key=TAVILY_API_KEY, k=10)
tools = [search_web]
...
llm_with_tools = llm.bind_tools(tools + [RequestAssistance], tool_choice="auto")
...
def chatbot(state: State) -> dict:
    ...
    try:
        ...
        return {"messages": [], "ask_human": True}
